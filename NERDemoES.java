...
public class NERDemoES {

    public static void main(String[] args) throws IOException {

      String serializedClassifier = "ner-model.3armf2016.ser.gz";
      ...
      */
      if (args.length > 1) {
        ...
        String s1 = "Los contribuyentes que expidan y reciban CFDI, deberán almacenarlos en medios magnéticos, ópticos o de cualquier otra tecnología, en su formato electrónico XML.";
